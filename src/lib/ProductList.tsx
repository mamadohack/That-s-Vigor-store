...
import { ProductListAPi } from "@/app/page";
    ...
    <section>
      <div className="mx-auto px-5 md:px-14">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-8">
          {ProductListAPi?.map((product: ProductListAPiType) => (
            <div key={product.id} className="space-y-2 group">
              <div className="relative h-[360px]">
                ...
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 space-x-2 min-w-max">
                  <button className="p-3 rounded-full bg-white text-xl translate-y-full group-hover:translate-y-0 duration-300 ease-in-out opacity-0 group-hover:opacity-100 hover:bg-red-600 hover:text-white hover:rotate-[360deg]">
                    <BsArrowsAngleExpand />
                  </button>
                  <button className="p-3 rounded-full bg-white text-xl translate-y-full group-hover:translate-y-0 duration-300 ease-in-out opacity-0 group-hover:opacity-100 delay-100 hover:bg-red-600 hover:text-white hover:rotate-[360deg]">
                    <LiaHeart />
                  </button>
                  <button className="p-3 rounded-full bg-white text-xl translate-y-full group-hover:translate-y-0 duration-300 ease-in-out opacity-0 group-hover:opacity-100 delay-200 hover:bg-red-600 hover:text-white hover:rotate-[360deg]">
                    <LiaShoppingBagSolid />
                  </button>
                </div>
              </div>
